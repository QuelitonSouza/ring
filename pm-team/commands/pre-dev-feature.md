...
- **Note:** For C# services requiring auth, reference `csharp.md` → Access Manager Integration section during TRD creation (Gate 2)
...
- **Note:** For C# services requiring license validation, reference `csharp.md` → License Manager Integration section during TRD creation (Gate 2)
