...
**not:**
- "Dependencies" (should be "Core Dependency: lib-commons-csharp")
- "Analyzers" (should be "Code Analysis")
- "Concurrency" (should be "Async/Await Patterns")
- "DI" (should be "Dependency Injection")
- "NRT" (should be "Nullable Reference Types")
