...
| Common Hallucination | Action |
|---------------------|--------|
| MediatR requirement | Verify in csharp.md "Frameworks & Libraries" section |
| AutoMapper requirement | Verify in csharp.md "Data Transformation" section |
| FluentValidation requirement | Verify in csharp.md "Frameworks & Libraries" section |
| NUnit / MSTest instead of xUnit | Check actual testing framework in csharp.md |
| Autofac / Ninject instead of built-in DI | Check DI framework in csharp.md |
| log4net / NLog instead of Serilog | Check logging library in csharp.md |
